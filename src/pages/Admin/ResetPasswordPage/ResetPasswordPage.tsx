...
export default function ResetPasswordPage() {
  ...
  function renderContent() {
    if (pageState === "loading") {
      return (
        <div className="reset-password__status">
          <Loader size={40} className="reset-password__spinner-icon" />
    ...
    if (pageState === "error") {
      return (
        <div className="reset-password__status">
          <AlertCircle size={40} className="reset-password__error-icon" />
          <h2>Invalid Link</h2>
          <p>{tokenError}</p>
    ...
    if (pageState === "success") {
      return (
        <div className="reset-password__status">
          <CheckCircle size={40} className="reset-password__success-icon" />
      ...
      <>
        ...
        <form className="login-form" onSubmit={handleSubmit}>
          ...
          <button
            ...
            disabled={loading}
          >
            {loading ? <span className="login-form__spinner" /> : "Reset Password"}
          </button>
        </form>
      </>
    );
